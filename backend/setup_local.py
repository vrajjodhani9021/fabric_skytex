...
def main() -> int:
    ...
    db_name = prompt("Database name you created in pgLogin", "fabrics")
    ...
    try:
        ...
        print("\nTips:")
        print("- Use the same password you enter in pgLogin for PostgreSQL 18")
    ...
    if not Login_pass:
        Login_pass = "Lollipop069"
        print("Using default Login password from README (change it after login).")
